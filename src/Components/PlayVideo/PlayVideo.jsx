...
const PlayVideo = ({videoId}) => {
  ...
  <div className='play-video'>
            ...
            <div className="vid-description">
                ...
                <hr />
                <h4>{apiData?value_converter(apiData.statistics.commentCount):102}Comemnts</h4>
    ...
    {commentData && Array.isArray(commentData) && commentData.map((item, index) => (
        <div key={index} className="comment">
            ...
            <div>
                ...
                <p>{item?.snippet?.topLevelComment?.snippet?.textDisplay || "No comment available"}</p>
                ...
                {/* {commentData.map((item,index)=>{
                    return(
                       <div key={index} className="comment">
                            <img src={item.snippet.topLevelComment.snippet.autherProfileImageUrl} alt="" />
                            <div>
                                <h3>{item.snippet.topLevelComent.snippet.authorDisplayName}<span>1 day ago</span></h3>
                                <p>{item.snippet.topLevelComent.snippet.textDisplay}</p>
                                <div className="comment-action">
                                    <img src={like} alt="" />
